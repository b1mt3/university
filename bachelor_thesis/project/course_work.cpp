...
// Единственный объект Ccourse_workApp

Ccourse_workApp theApp;


// инициализация Ccourse_workApp
...
// обработчики сообщений Ccourse_workApp
...
// Ccourse_workApp настройка методов загрузки и сохранения
